...
//
//
//public class DoAble extends LiveObject implements PropertyChanging {
//
//    private String name;
...
//
//
//    public void doSomething(Action act, LiveObject obj, Flag flag) {
//
//        if(flag == Flag.AFTER) {
//            doSomething(act);
//            objName = obj.getName();
...
//    }
//    public void doSomething(Action act, LiveObject obj, Flag flag, String newProperty){
